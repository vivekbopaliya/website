...
export default function SectionTwo() {
  return (
    <main className="relative min-h-[200px] flex gap-7 flex-col text-center items-center py-16 sm:py-32 px-4 sm:px-6">
      <div className="relative z-10 flex flex-col items-center gap-7">
        <p className="font-bold text-3xl sm:text-4xl tracking-normal text-center">
          Struggling to get Paid on Time?
        </p>

        <p className="font-extralight text-xs sm:text-md tracking-wide text-center px-4">
